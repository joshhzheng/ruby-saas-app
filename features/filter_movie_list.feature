...
Scenario: all ratings selected
  ...
  When I press "Refresh"
  Then I should see the following movies: Aladdin, The Help, Chocolat, 2001: A Space Odyssey, Chicken Run, The Terminator, When Harry Met Sally, Amelie, The Incredibles, Raiders of the Lost Ark
